<template>
  <div>
  	...
  	<a @click="goback"><img class="goback" src="static/arrow.svg"></a>
    ...
    <div class="header-info">
	    <div class="info-title">
	    	<span>{{house_detail.house_title}}</span>
	    </div>
	    <div class="info-releasetime">
	    	<span>{{house_detail.house_releasetime}} &nbsp;&nbsp; 浏览{{house_detail.house_browsenum}}次</span>
	    </div>
  	...
  	<div class="main-info">
  		<div class="info-price">
  			<span>¥{{house_detail.house_rent}}/天</span>
  		</div>
  		<div class="info-vr">
  			<span></span>
  		</div>
...
export default {
	...
	methods:{
		_getDetails(){
			...
			axios.get('http://app.mxzlw.cn/qiu/page/details.php?houseID='+aId).then((res) => {
